    ...
    <body>
        <nav class="navbar bg-body-tertiary bg-dark">
            <div class="container-fluid px-5">
              ...
              <a class="btn btn-primary  ms-2 px-5 me-4 text-ligh" href="{{url('logout')}}">Logout</a>
        ...
        <div class="vh-100 d-flex justify-content-center align-items-center ">
            <div class="container text-center shadow-sm ">
                ...
                @endif
                <form method="POST" action="{{url('/adduser/store')}}">
                    @csrf
                    <div class="row ">
                        <div class="col">
                            <div class="row mb-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <button class="btn btn-primary col-6 mt-4 " type="submit" onclick="validateRegister()" >Add</button>
                        </div>
                    </div>
                </form>
