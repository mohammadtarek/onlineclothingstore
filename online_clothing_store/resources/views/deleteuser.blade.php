...
<body>
    ...
    <div class="vh-100 d-flex justify-content-center align-items-center ">
        <div class="col-md-5 p-5 shadow-sm ">
            <h2 class="text-center mb-4 text-primary">Delete User</h2>
            <form  method="post" action="{{ url('/deleteuser/delete') }}">
                @csrf
                <div class="mb-3">
                    ...
                    placeholder="Enter User Email Here" required maxlength="30" minlength="10">
                </div>
            ...
            @endif
                <div class="container text-center">
                    <button class="btn btn-primary col-4 p-3" onclick="deleteUser()" type="submit" id="deleteUserBtn">Delete User</button>
                </div>
            </form>
